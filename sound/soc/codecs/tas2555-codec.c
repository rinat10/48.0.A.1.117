	...
	int nClkID, unsigned int nFreqency, int nDir)
{
	...
	dev_err(pTAS2555->dev, "tas2555_set_dai_sysclk: freq = %u\n", nFreqency);
	...
	struct snd_ctl_elem_value *pUcontrol)
{
	...
	dev_err(pTAS2555->dev, "%s: Get address [%d, %d, %d]\n", __func__,
	...
	struct snd_ctl_elem_value *pUcontrol)
{
	...
	dev_err(pTAS2555->dev, "%s: Set address [%d, %d, %d]\n", __func__,
		register_addr.book, register_addr.page, register_addr.reg);
	...
	struct snd_ctl_elem_value *pUcontrol)
{
	...
	dev_err(pTAS2555->dev, "%s: Read [%d, %d, %d] = %ld\n", __func__,
		register_addr.book, register_addr.page, register_addr.reg,
	...
	struct snd_ctl_elem_value *pUcontrol)
{
	...
	dev_err(pTAS2555->dev, "%s: Write [%d, %d, %d] = %ld\n", __func__,
		register_addr.book, register_addr.page, register_addr.reg,
		pUcontrol->value.integer.value[0]);
	...
	struct snd_ctl_elem_value *pValue)
{
	...
	dev_err(pTAS2555->dev, "tas2555_power_ctrl_get = %d\n",
	...
	struct snd_ctl_elem_value *pValue)
{
	...
	dev_err(pTAS2555->dev, "tas2555_power_ctrl_put = %d\n",
		pTAS2555->mnPowerCtrl);
	...
	struct snd_ctl_elem_value *pValue)
{
	...
	dev_err(pTAS2555->dev, "tas2555_fs_get = %d\n", nFS);
	return 0;
}
	...
	struct snd_ctl_elem_value *pValue)
{
	...
	dev_err(pTAS2555->dev, "tas2555_fs_put = %d\n", nFS);
	...
	struct snd_ctl_elem_value *pValue)
{
	...
	dev_err(pTAS2555->dev, "tas2555_program_get = %d\n",
	...
	struct snd_ctl_elem_value *pValue)
{
	...
	dev_err(pTAS2555->dev, "tas2555_configuration_get = %d\n",
...
static const struct snd_kcontrol_new tas2555_snd_controls[] = {
	SOC_SINGLE_TLV("DAC Playback Volume", TAS2555_SPK_CTRL_REG, 3, 0x0f, 0, dac_tlv),
	SOC_SINGLE_MULTI_EXT("Reg Addr", 0, 0, INT_MAX, 0, 3, tas2555_get_reg_addr, tas2555_put_reg_addr),
	SOC_SINGLE_EXT("Reg Value", SND_SOC_NOPM, 0, 0xFFFF, 0, tas2555_get_reg_value, tas2555_put_reg_value),
	SOC_SINGLE_EXT("PowerCtrl", SND_SOC_NOPM, 0, 0x0001, 0, tas2555_power_ctrl_get, tas2555_power_ctrl_put),
	SOC_SINGLE_EXT("Program", SND_SOC_NOPM, 0, 0x00FF, 0, tas2555_program_get, tas2555_program_put),
	SOC_SINGLE_EXT("Configuration", SND_SOC_NOPM, 0, 0x00FF, 0, tas2555_configuration_get, tas2555_configuration_put),
	SOC_SINGLE_EXT("FS", SND_SOC_NOPM, 8000, 48000, 0, tas2555_fs_get, tas2555_fs_put),
	SOC_SINGLE_EXT("Calibration", SND_SOC_NOPM, 0, 0x00FF, 0, tas2555_calibration_get, tas2555_calibration_put),
};
